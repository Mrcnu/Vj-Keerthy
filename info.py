...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://crazysrinuu:YGgFoi0UbQxLNKzC@cluster0.yeh6f.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
REFERAL_COUNT = int(environ.get('REFERAL_COUNT', '6')) # number of referal count
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '93843ff7f2912f1c8994ed53b1abd2037a74a823')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'http://t.me/HowToOpenThisLinkss/19')
